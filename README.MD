...
It allows users to have conversations and manage sessions through a command-line interface.

Conversation state is mapped to the terminal/shell session, 
and can be restored/loaded later and renamed to something more useful.
